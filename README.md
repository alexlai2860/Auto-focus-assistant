...
- **由于个人原因（包括资金因素、研究兴趣&拍摄内容的改变等等），后续可能无法继续推进该项目**
- **但我也会继续在影视相关的领域做一些探索，敬请期待**
- **希望对民用影视工业化和智能化发展起到一点小小的帮助**<br> 
...
+ 自动对焦
    ...
    + CAL按键:用于自动对焦下模式选择<br>
      ...
      中心点对焦/中心区域对焦<br>
      未来将开放更多的物体识别模式<br>       
    + 最新的一次更新中，加入了在中心区域对焦模式下，用滚轮改变对焦框大小的功能<br>
      可以针对不同大小和距离的目标进行有效调整<br>
+ 手动对焦
...
- 测试结果: cpu核心平均占用约为40%，内存平均占用3.15G(空闲时为3.05G)
           ...
           采用77wh的F970电池或75wh的希铁外接电池可以供电3.5-4h<br>
**更新**：<br>
- CPU: Intel N100                 
- 希铁: ubuntu 23.04
- 功率：默认状态，不开启性能模式
...
+ #### 关于当前方案的缺陷/可改进的方向                            
  + **功耗**      
    ...
    + 另一个可能的方案是将算法移植到arm平台，尤其是具有强大npu的arm平台，如英伟达的jetson系列和瑞芯微rk3588等平台，理论上可以降低功耗并使用npu进行推理<br>

  + **易用性**
    + 由于本人能力有限，没有给项目编写QT界面，建议在后续研发中完善人机交互体验，使用触摸屏进行交互
    + 同时也可以通过蓝牙和wifi进行交互和更改参数，希望后续进一步研发<br>
